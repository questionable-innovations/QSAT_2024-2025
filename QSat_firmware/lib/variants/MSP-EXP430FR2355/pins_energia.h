...
// We don't have an external crystal on the LaunchPad
...
// CUSTOM _ no idea why it wasn't defined
static const uint8_t P2_6 = 47;
static const uint8_t P2_7 = 48;
...
const uint8_t digital_pin_to_timer[] = {
	...
	NOT_ON_TIMER,  /* 47 - P2.6 */
	NOT_ON_TIMER,  /* 48 - P2.7 */
};
